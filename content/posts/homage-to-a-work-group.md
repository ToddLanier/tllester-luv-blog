...
categories: 
  - "texts"
coverImage: "work-group-image.png"
date: 2020-10-09
id: 4001
slug: "homage-to-a-work-group"
title: "Homage to a working group"
type: "post"
---

Luv 'til it Hurts was at first [a two-year project](/why-make-an-open-work/), and is now something much more. I admit that I don't want to limit its future potential by saying what it is/isn't or what it's become. However, there are three ways to clearly 'see it'. In a recent grant application, I described our group of three coordinators (Brad Walrond, Paula Nishijima & myself) as a 'working group'. Brad suggested 'The Work Group' instead, and the name seems to have stuck. A traveling group show called [EXQUISITE CORPSE](/exquisite-corpse/) has been conceived by The Work Group. And, I continue to develop the [LUV Fund](/luv-fund/), an apparatus to deliver faster resources to HIV-related cultural activism, as well as to acknowledge the role of the artist in public health & social movements pertaining to HIV/AIDS. With such a lofty title as The Work Group, it is incumbent on us to say what we do. Our new website is forthcoming, and that explains us rather well. In the meantime, I've taken 'a stab' at explaining who we are and what we do:
...
- Applying techniques and tools from their individual practices, the WORK GROUP encourages rhizomatic offshoots from the overall EXQUISITE CORPSE process (e.g. R&D, online extension, archiving, co-authored texts, venue network, community engagement, public progarmme- & exhibition-making) whereby one set of interactions generates the next. [Game of Swarms](/game-of-swarms-descends-upon-luv/), Every Where Alien’s [Poetics + Pandemics](/every-where-aliens-poetics-pandemics/) open mic series and [The LUV Fund](/luv-fund/) are all examples;
...
**ITEMS INCLUDED IN HANDOVER FROM INDIVIDUAL PROJECT TO GROUP PROCESS**
